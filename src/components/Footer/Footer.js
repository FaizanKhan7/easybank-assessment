...
function Footer() {
  return (
    <footer>
      <div className="d-md-flex flex-md-row justify-content-between align-items-center footerWrapper">
        <div className="logoLinks">
          <img src={Logo} alt="" />
          <div className="d-flex justify-content-around socialLinks">
        ...
        <div className="d-flex flex-column align-items-center pageLinks">
          <li>About Us</li>
          <li>Contact</li>
          <li>Blog</li>
        </div>
        ...
        <div className="d-md-flex flex-column justify-content-md-end align-items-md-end copyRight">
          <Btn style={{ display: "block", margin: "20px auto" }} />
          <p>©️ Easybank. All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
